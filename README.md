...
2. ### What is a prototype chain
   ...
   **Prototype chaining** is used to build new types of objects based on existing ones. It is similar to inheritance in a class based language.
   ...
   If it doesn’t find it, it looks up the prototype chain, checking the prototype and then the prototype’s prototype, and so on, until it reaches the end of the chain (usually null).
   This allows for sharing methods across multiple instances, promoting code reuse.
...
To iterate over the properties of an object, you can use for...in, Object.keys(), Object.values(), or Object.entries().
javascript
Maps are iterable directly using forEach, for...of, or the entries() method.
...
Functions treated as values, passed as arguments or returned.
...
22. ### How do you redeclare variables in switch block without an error
...
27. ### What is Hoisting
  ...
  Hoisting is a JavaScript mechanism where variables and function declarations are moved to the top of their containing scope (either global or function scope) during the compile phase, before the code is executed.
    ```javascript
...
55. ### What are the three states of promise
